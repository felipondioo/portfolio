...
$pdf->MultiCell(70, 5, convertirTexto($ubicacion), 0, 'L');
...
foreach ($estudios as $estudio) {
    ...
    $pdf->SetFont('NunitoSansB', 'B', 12);
    asignarX();
    $anchoFijo = 100 ; // Ancho fijo que desees asignar
    $pdf->MultiCell($anchoFijo, 6, convertirTexto($estudio['institucion']), 0, 'L'); // L alinea a la izquierda
